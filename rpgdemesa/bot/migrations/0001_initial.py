# Generated by Django 3.2.6 on 2021-10-14 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.DateTimeField(default=datetime.datetime(2021, 10, 14, 11, 6, 24, 523160))),
                ('descricao', models.CharField(max_length=200)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='bot.item')),
                ('loja', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='bot.loja')),
